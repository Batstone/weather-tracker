        ...
        <div className="weather-container">
            ...
            <div className="weather">
                {icon ? hourly.map((hour) => {
                    ...
                    return (
                        <div key={hour.dt} className="weather__details">
                            <div className="weather__details__container-1">
                                ...
                                <div className="weather__details__container-1__description">
                                    <div className="weather__details__container-1__img"><img src={`http://openweathermap.org/img/wn/${hour.weather[0].icon}@2x.png`}></img></div>
